...
/*FLASH->ACR |= FLASH_ACR_PRFTEN | FLASH_ACR_LATENCY_5WS;
 //RCC->PLLCFGR = 0;
 RCC->PLLCFGR = RCC_PLLCFGR_PLLSRC_HSE | RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLM_3 |
 RCC_PLLCFGR_PLLN_4 | RCC_PLLCFGR_PLLN_6 | RCC_PLLCFGR_PLLN_8; //| RCC_PLLCFGR_PLLP_0;
 
 RCC->CR |= RCC_CR_PLLON;
 while (!(RCC->CR & RCC_CR_PLLRDY)) {};
 RCC->CFGR = RCC_CFGR_SW_PLL | RCC_CFGR_PPRE1_0 | RCC_CFGR_PPRE1_2 | RCC_CFGR_PPRE2_2 | RCC_CFGR_RTCPRE_3;
